...
const halfling = new MessageEmbed()
	.setColor('#0099ff')
	.setTitle('Halfling')
	.addFields(
...
const draconato = new MessageEmbed()
	.setColor('#0099ff')
	.setTitle('Draconato')
	.addFields(
...
const meioElfo = new MessageEmbed()
	.setColor('#0099ff')
	.setTitle('meio-elfo')
	.addFields(
...
const meioOrc = new MessageEmbed()
	.setColor('#0099ff')
	.setTitle('meio-orc')
	.addFields(
...
const tiefling = new MessageEmbed()
	.setColor('#0099ff')
	.setTitle('tiefling')
	.addFields(
