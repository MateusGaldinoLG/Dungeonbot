...
const artificeEmb = new MessageEmbed()
	.setColor('#0099ff')
	.setTitle('Artifice')
	.addFields(
...
const barbaroEmb = new MessageEmbed()
	.setColor('#0099ff')
	.setTitle('Barbaro')
	.addFields(
...
const bardoEmb = new MessageEmbed()
	.setColor('#0099ff')
	.setTitle('Bardo')
	.addFields(
...
const bruxoEmb = new MessageEmbed()
	.setColor('#0099ff')
	.setTitle('Bruxo')
	.addFields(
...
const clerigoEmb = new MessageEmbed()
	.setColor('#0099ff')
	.setTitle('Clerigo')
	.addFields(
...
const druidaEmb = new MessageEmbed()
	.setColor('#0099ff')
	.setTitle('Druida')
	.addFields(
...
const feiticeiroEmb = new MessageEmbed()
	.setColor('#0099ff')
	.setTitle('Feiticeiro')
	.addFields(
...
const guerreiroEmb = new MessageEmbed()
	.setColor('#0099ff')
	.setTitle('Guerreiro')
	.addFields(
...
const ladinoEmb = new MessageEmbed()
	.setColor('#0099ff')
	.setTitle('Ladino')
	.addFields(
...
const magoEmb = new MessageEmbed()
	.setColor('#0099ff')
	.setTitle('Mago')
	.addFields(
		{ name: 'Características de classe: ', value: 'Valor de habilidade: Inteligência, seguido de Constituição ou Destreza \n Vida base: 6 + Constituição \n Dado de vida: 1d6 + modificador de Constituição' },
...
const mongeEmb = new MessageEmbed()
	.setColor('#0099ff')
	.setTitle('Monge')
	.addFields(
...
const paladinoEmb = new MessageEmbed()
	.setColor('#0099ff')
	.setTitle('Paladino')
	.addFields(
...
const patrulheiroEmb = new MessageEmbed()
	.setColor('#0099ff')
